...
class Exam(Base):
    ...
    __table__ = Table(
        ...
        CheckConstraint("scope IN ('SINGLE_BRANCH', 'ALL_BRANCHES', 'SELECTED_BRANCHES')", name="sms_exams_scope_check"),
        CheckConstraint("status IN ('DRAFT', 'SUBMITTED', 'RETURNED_FOR_CORRECTION', 'PUBLISHED')", name="sms_exams_status_check"),
...
class StudentExamRecord(Base):
    ...
    __table__ = Table(
        ...
        CheckConstraint("status IN ('DRAFT', 'SUBMITTED', 'RETURNED_FOR_CORRECTION', 'PUBLISHED')", name="sms_student_exam_records_status_check"),
