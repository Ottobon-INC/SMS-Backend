...
from app.modules.dashboard.schemas import OfficeStaffDashboardResponse
...
def get_office_staff_dashboard(
    ...
    return DashboardService(DashboardRepository(session)).get_office_staff_dashboard(context)
